				...
				<form method="post">
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="input1" required name="id" value="${user.id }">
					...
					<div class="form-group">
						...
						<input type="password" class="form-control" id="input2" required name="password" value="${user.password }">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="input5" required name="nickName" value="${user.nickName }">
		...
		$(document)
				.ready(
						function() {
							...
							// /user/nickNameCheck 로 요청 보낸 결과에 따라
