	...
	<div class="menu">
		<ul class="nav-item active">
			<li class="MR nav-item active">
				<a class="nav-link" href="../main/recommend"> 영화 추천 </a>
			</li>
			<li class="nav-item active">
				<a class="nav-link" href="../movie/list"> 영화 목록 </a>
			</li>
			<li class="nav-item active">
				<a class="nav-link" href="../actor/actorlist"> 배우 목록 </a>
			</li>
			<li class="nav-item active">
				<a class="nav-link" href="../main/recommend"> 평론 </a>
			</li>
			<li class="nav-item active">
				<a class="nav-link" href="../main/recommend"> 자유게시판 </a>
			</li>
